...
export default function AccordionPage() {
  const basicItems = [
    {
      ...
      content: (
        <p class="text-surface-700 dark:text-surface-300">
          Content for section 1. This is the first panel with some example text.
        </p>
      ),
      defaultOpen: true,
    },
    {
      ...
      content: (
        <p class="text-surface-700 dark:text-surface-300">
          Content for section 2. Click to expand and see this content.
        </p>
      ),
    },
    {
      ...
      content: (
        <p class="text-surface-700 dark:text-surface-300">
          Content for section 3. Another panel with different content.
        </p>
      ),
    },
  ];
  ...
  const faqItems = [
    {
      ...
      content: (
        <p class="text-surface-700 dark:text-surface-300">
          Glass UI is an iOS 26-inspired glassmorphism component library for
          SolidJS. It provides beautiful, modern UI components with glass-like
          effects.
        </p>
      ),
    },
    {
      ...
      content: (
        <div class="text-surface-700 dark:text-surface-300">
          <p class="mb-2">
            You can install Glass UI using your preferred package manager:
          </p>
    ...
    },
    {
      ...
      content: (
        <p class="text-surface-700 dark:text-surface-300">
          Yes! Glass UI is designed for production use with full TypeScript
          support, accessibility features, and comprehensive documentation.
        </p>
      ),
    },
  ];
  ...
  return (
    <div class="space-y-8">
      ...
      <DemoSection
        title="Import"
        code="import { Accordion, AccordionPanel } from 'glass-ui-solid';"
      />
        ...
        <div class="space-y-6">
          ...
          <div>
            ...
            <p class="text-sm text-surface-500 dark:text-surface-400 mb-3">
              Use the <CodePill>multiple</CodePill> prop to allow multiple
          ...
          <div>
            ...
            <p class="text-sm text-surface-500 dark:text-surface-400 mb-3">
              For simpler use cases, you can use individual AccordionPanel
              components.
            </p>
