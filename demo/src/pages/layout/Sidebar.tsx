import { Button, Card, Sidebar } from 'glass-ui-solid';
...
export default function SidebarPage() {
  ...
  return (
    <div class="space-y-8">
      ...
      <DemoSection
        title="Import"
        code="import { Sidebar } from 'glass-ui-solid';"
      />
        ...
        <PropsTable
          ...
          props={[
            ...
            },
            {
              name: 'children',
              type: 'SidebarItem[]',
              description: 'Nested child items for groups',
            },
            {
              name: 'badge',
              type: 'string | number',
        ...
        <PropsTable
          props={[
            ...
            },
            {
              ...
              type: 'boolean',
              default: 'false',
              description: 'Whether sidebar is collapsed (icon-only)',
            },
            {
