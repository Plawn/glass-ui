...
export default function DialogPage() {
  ...
  return (
    <div class="space-y-8">
      ...
      <DemoSection
        title="Import"
        code="import { Dialog, useDisclosure } from 'glass-ui-solid';"
      />
      ...
      <DemoSection
        ...
        description={
          <>
            Use the <CodePill>danger</CodePill> variant for destructive actions
            like deleting accounts or removing important data.
          </>
        }
        code={dangerExample}
      >
        <Button variant="danger" onClick={dangerDialog.onOpen}>
          Delete Account
        </Button>
        <Dialog
      ...
      >
        ...
        <Dialog
          ...
          onOpenChange={(open) =>
            !open && !loading() && loadingDialog.onClose()
          }
          title="Save Changes"
      ...
      <DemoSection title="Variants" card={false}>
        <div class="space-y-4">
          ...
          <Card class="p-4">
            ...
            <p class="text-surface-600 dark:text-surface-400 text-sm">
              Red/danger styled confirm button. Use for destructive actions like
              delete, remove, etc.
            </p>
          </Card>
        </div>
