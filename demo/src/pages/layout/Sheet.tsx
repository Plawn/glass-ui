import { Button, Sheet } from 'glass-ui-solid';
...
export default function SheetPage() {
  ...
  return (
    <div class="space-y-8">
      ...
      <DemoSection
        title="Import"
        code="import { Sheet } from 'glass-ui-solid';"
      />
      ...
      <DemoSection title="Basic Usage" code={basicCode}>
        ...
        <Sheet open={basicOpen()} onOpenChange={setBasicOpen}>
          <div class="p-6">
            <h3 class="text-xl font-semibold text-surface-900 dark:text-white mb-4">
              Sheet Content
            </h3>
            <p class="text-surface-600 dark:text-surface-400 mb-4">
              This is a basic sheet. Drag the handle to resize or dismiss, or
      ...
      >
        ...
        >
          <div class="p-6">
            ...
            <p class="text-surface-600 dark:text-surface-400 mb-4">
              This sheet has three snap points: 25%, 50%, and 90% of the
              viewport height. Drag up or down to snap to different heights.
            </p>
      ...
      >
        ...
        <Sheet
          ...
          onOpenChange={setNonDismissibleOpen}
          dismissible={false}
        >
          <div class="p-6">
            <h3 class="text-xl font-semibold text-surface-900 dark:text-white mb-4">
        ...
        <PropsTable
          props={[
            ...
            },
            {
              ...
              type: 'number[]',
              default: '[0.5]',
              description: 'Snap points as percentages (0-1)',
            },
            {
              name: 'defaultSnapPoint',
              type: 'number',
              default: 'last index',
              description: 'Default snap point index',
            },
            {
              name: 'dismissible',
              type: 'boolean',
              default: 'true',
              description: 'Whether the sheet can be dragged to close',
            },
            {
              name: 'showHandle',
              type: 'boolean',
              default: 'true',
              description: 'Whether to show the drag handle indicator',
            },
            {
              name: 'class',
              type: 'string',
