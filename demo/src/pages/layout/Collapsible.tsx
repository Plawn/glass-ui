import { Button, Card, Collapsible } from 'glass-ui-solid';
...
export default function CollapsiblePage() {
  ...
  return (
    <div class="space-y-8">
      ...
      <DemoSection
        title="Import"
        code="import { Collapsible } from 'glass-ui-solid';"
      />
        ...
        <div class="space-y-6">
            ...
            >
              <div class="p-4 mt-2 rounded-lg bg-surface-50 dark:bg-surface-800/50">
                <p class="text-surface-600 dark:text-surface-400">
                  This is the collapsible content. It smoothly animates in and
                  out using CSS grid transitions.
                </p>
              </div>
            </Collapsible>
          </DemoSection>
          ...
          >
            <div class="flex gap-2">
              <Button size="sm" onClick={() => setControlled(true)}>
                Open
              </Button>
              <Button
                size="sm"
          ...
          <DemoSection title="FAQ Pattern" subsection cardClass="p-6 space-y-2">
            ...
            >
              <div class="px-3 pb-3">
                <p class="text-surface-600 dark:text-surface-400">
                  Glass UI is an iOS 26-inspired glassmorphism component library
                  for SolidJS.
                </p>
              </div>
            </Collapsible>
            ...
            >
              <div class="px-3 pb-3">
                <p class="text-surface-600 dark:text-surface-400">
                  Run <CodePill>npm install glass-ui-solid</CodePill> or use
          ...
          props={[
            {
              ...
              type: 'JSX.Element',
              default: 'required',
              description: 'The element that toggles the collapsible',
            },
            {
              name: 'children',
              type: 'JSX.Element',
            ...
            },
            {
              ...
              type: 'boolean',
              default: 'false',
              description: 'Disable the collapsible interaction',
            },
            {
              name: 'class',
              type: 'string',
      ...
      <DemoSection title="Accessibility">
        <FeatureList
          ...
          items={[
            <>
              Trigger has <CodePill>role="button"</CodePill> with proper
            ...
            <>
              ...
              <CodePill>aria-disabled</CodePill>
            </>,
          ]}
        />
      </DemoSection>
