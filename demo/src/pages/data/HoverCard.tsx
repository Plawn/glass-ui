import { HoverCard, Button, Avatar, Badge } from 'glass-ui-solid';
...
export default function HoverCardPage() {
  return (
    <div class="space-y-8">
      ...
      <DemoSection title="Import" code="import { HoverCard } from 'glass-ui-solid';" />
...
>
  <div class="p-3">This won't show</div>
      ...
      <DemoSection title="Props" card={false}>
        <PropsTable
          props={[
            { name: 'trigger', type: 'JSX.Element', default: 'required', description: 'Element that triggers the hover card' },
            { name: 'children', type: 'JSX.Element', default: 'required', description: 'Content displayed in the hover card' },
            { name: 'placement', type: "'top' | 'bottom' | 'left' | 'right'", default: "'bottom'", description: 'Placement relative to trigger' },
            ...
            { name: 'disabled', type: 'boolean', default: 'false', description: 'Disable the hover card' },
            { name: 'contentClass', type: 'string', default: '-', description: 'Additional CSS classes for content' },
            { name: 'class', type: 'string', default: '-', description: 'Additional CSS classes for wrapper' },
          ]}
        />
      </DemoSection>
    </div>
