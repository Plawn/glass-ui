...
export default function TabsPage() {
  ...
  const basicItems: TabItem[] = [
    ...
    },
    {
      ...
      label: 'Details',
      content: (
        <div class="p-4">Details content with more specific information.</div>
      ),
    },
    {
      id: 'tab3',
      label: 'Settings',
      content: <div class="p-4">Settings panel for configuration options.</div>,
    },
  ];
  ...
  const itemsWithBadges: TabItem[] = [
    {
      id: 'all',
      label: 'All',
      content: <div class="p-4">All items displayed here.</div>,
    },
    {
      id: 'unread',
      label: 'Unread',
      badge: 5,
      content: <div class="p-4">5 unread items.</div>,
    },
    {
      id: 'flagged',
      label: 'Flagged',
      badge: 2,
      content: <div class="p-4">2 flagged items.</div>,
    },
  ];
  ...
  const itemsWithDisabled: TabItem[] = [
    {
      id: 'active1',
      label: 'Active',
      content: <div class="p-4">This tab is active and clickable.</div>,
    },
    {
      id: 'disabled',
      label: 'Disabled',
      disabled: true,
      content: <div class="p-4">This content is hidden.</div>,
    },
    {
      id: 'active2',
      label: 'Another Active',
      content: <div class="p-4">Another active tab panel.</div>,
    },
  ];
  ...
  const verticalItems: TabItem[] = [
    {
      id: 'general',
      label: 'General',
      content: <div class="p-4">General settings and preferences.</div>,
    },
    {
      id: 'account',
      label: 'Account',
      content: <div class="p-4">Account information and security.</div>,
    },
    {
      id: 'notifications',
      label: 'Notifications',
      content: <div class="p-4">Notification preferences.</div>,
    },
    {
      id: 'privacy',
      label: 'Privacy',
      content: <div class="p-4">Privacy and data settings.</div>,
    },
  ];
...
<Button onClick={() => setActiveTab('tab2')}>Go to Tab 2</Button>`}
      ...
      <DemoSection
        ...
        description={
          <>
            Use the <CodePill>lazy</CodePill> prop to only render tab content
            when active. Combine with <CodePill>keepMounted</CodePill> to
            preserve state after switching away.
          </>
        }
        ...
        <PropsTable
          props={[
            ...
            },
            {
              ...
              type: 'boolean',
              default: 'false',
              description: 'Stretch tabs to fill width',
            },
            {
              name: 'orientation',
            ...
            },
            {
              ...
              type: 'boolean',
              default: 'false',
              description: 'Keep inactive content mounted',
            },
            {
              name: 'tabListClass',
              type: 'string',
              description: 'Tab list container class',
            },
            {
              name: 'contentClass',
              type: 'string',
              description: 'Content panel class',
            },
          ]}
        />
      </DemoSection>
