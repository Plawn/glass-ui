...
const ChevronRightIcon = () => (
  <svg
    class="w-4 h-4 mx-2 text-surface-400"
    fill="none"
    stroke="currentColor"
    viewBox="0 0 24 24"
  >
      ...
      <DemoSection title="Accessibility" card={false}>
        <ul class="list-disc list-inside text-surface-600 dark:text-surface-400 space-y-2">
          <li>
            ...
            <CodePill>aria-label="Breadcrumb"</CodePill>
          </li>
          <li>
            Ordered list (<CodePill>&lt;ol&gt;</CodePill>) for proper hierarchy
          </li>
          <li>
            Current page marked with <CodePill>aria-current="page"</CodePill>
          </li>
          <li>
            Separator elements are hidden from screen readers with{' '}
            <CodePill>aria-hidden="true"</CodePill>
          </li>
        </ul>
      </DemoSection>
    </div>
