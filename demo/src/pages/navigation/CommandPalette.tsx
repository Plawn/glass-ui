import { Button, CommandPalette } from 'glass-ui-solid';
import type {
    ...
    <div class="space-y-8">
      ...
      <DemoSection
        ...
        description={
          <>
            Press{' '}
            <kbd class="px-2 py-1 text-xs font-medium bg-surface-100 dark:bg-white/10 rounded border border-surface-200 dark:border-white/10">
              Cmd+K
            </kbd>{' '}
            (or{' '}
            <kbd class="px-2 py-1 text-xs font-medium bg-surface-100 dark:bg-white/10 rounded border border-surface-200 dark:border-white/10">
            ...
            on Windows) to open the command palette.
          </>
        }
        code={`const commands = [
      ...
      >
        <div class="flex items-center gap-4 flex-wrap">
          ...
          <span class="text-sm text-surface-500 dark:text-surface-400">
            or press{' '}
            <kbd class="px-1.5 py-0.5 text-xs font-medium bg-surface-100 dark:bg-white/10 rounded border border-surface-200 dark:border-white/10">
              Cmd+K
            </kbd>
          </span>
        </div>
...
// paletteRef.isOpen() - Check if open`}
      ...
      >
        <div class="flex items-center gap-3">
          ...
          <Button variant="secondary" onClick={() => paletteRef?.close()}>
            close()
          </Button>
          <Button variant="secondary" onClick={() => paletteRef?.toggle()}>
            toggle()
          </Button>
        </div>
      </DemoSection>
      ...
      <DemoSection
        ...
        description={
          <>
            ...
            <code class="text-sm bg-surface-100 dark:bg-white/10 px-1.5 py-0.5 rounded">
              open
            </code>{' '}
            and{' '}
            <code class="text-sm bg-surface-100 dark:bg-white/10 px-1.5 py-0.5 rounded">
        ...
        <PropsTable
          props={[
            ...
            },
            {
              ...
              type: 'boolean',
              default: 'false',
              description: 'Disable keyboard shortcut',
            },
            {
              name: 'placeholder',
              type: 'string',
            ...
            },
            {
              name: 'recentIds',
              type: 'string[]',
              description: 'Recent item IDs (shown first)',
            },
            {
              name: 'open',
              type: 'boolean',
            ...
            },
            {
              name: 'ref',
              type: '(handle) => void',
              description: 'Imperative handle ref',
            },
          ]}
        />
      </DemoSection>
        ...
        <PropsTable
          ...
          props={[
            ...
            },
            {
              name: 'data',
              type: 'T',
              description: 'Custom data attached to item',
            },
          ]}
        />
      </DemoSection>
        ...
        <PropsTable
          ...
          props={[
            ...
            { name: 'toggle()', type: '', description: 'Toggle open state' },
            {
              name: 'isOpen()',
              type: '',
              description: 'Check if palette is open',
            },
          ]}
        />
      </DemoSection>
