import { Button, Menu } from 'glass-ui-solid';
        ...
        <Menu
          ...
          items={[
            ...
            { label: 'Unavailable', disabled: true },
            {
              ...
              onClick: () => handleAction('Also Available'),
            },
          ]}
        />
      </DemoSection>
          ...
          props={[
            {
              ...
              type: 'string',
              default: 'required*',
              description: 'Display label (*required unless divider is true)',
            },
            {
              name: 'onClick',
              type: '() => void',
            ...
            },
            {
              ...
              type: 'boolean',
              default: 'false',
              description: 'Render as a divider line',
            },
          ]}
        />
      </DemoSection>
