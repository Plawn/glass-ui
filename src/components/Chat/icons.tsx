...
/**
 * Stop icon for canceling streaming
 */
...
/**
 * Wrench icon for tool call sections
 */
export const ToolCallIcon: Component<IconProps> = (props) => {
 ...
 */
export const ThinkingIcon: Component<IconProps> = (props) => {
  const size = () => props.size ?? 16;
